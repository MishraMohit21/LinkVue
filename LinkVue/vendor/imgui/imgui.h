...
namespace ImGui
{
    ...
    IMGUI_API bool          DragFloat2(const char* label, ImVec2& vec, float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char* format = "%.3f", ImGuiSliderFlags flags = 0);
